...
#include "project_one/srv/detail/odd_even_check__rosidl_typesupport_fastrtps_c.h"
...
#include "project_one/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _OddEvenCheck_Request__ros_msg_type = project_one__srv__OddEvenCheck_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_project_one
size_t get_serialized_size_project_one__srv__OddEvenCheck_Request(
  const void * untyped_ros_message,
...
static uint32_t _OddEvenCheck_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_project_one__srv__OddEvenCheck_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_project_one
size_t max_serialized_size_project_one__srv__OddEvenCheck_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = project_one__srv__OddEvenCheck_Request;
    is_plain =
      (
...
static size_t _OddEvenCheck_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_project_one__srv__OddEvenCheck_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, project_one, srv, OddEvenCheck_Request)() {
...
using _OddEvenCheck_Response__ros_msg_type = project_one__srv__OddEvenCheck_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_project_one
size_t get_serialized_size_project_one__srv__OddEvenCheck_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _OddEvenCheck_Response__ros_msg_type * ros_message = static_cast<const _OddEvenCheck_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_project_one__srv__OddEvenCheck_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_project_one
size_t max_serialized_size_project_one__srv__OddEvenCheck_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = project_one__srv__OddEvenCheck_Response;
    is_plain =
      (
...
static size_t _OddEvenCheck_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_project_one__srv__OddEvenCheck_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, project_one, srv, OddEvenCheck_Response)() {
...
// already included above
// #include "project_one/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "project_one/srv/odd_even_check.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, project_one, srv, OddEvenCheck)() {
